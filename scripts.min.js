...
$(document).on('click', 'form button', function(){
  $(this).parents('form').find('.check').val('stopSpam');
});

$('input[name="auto_app_agree"]').change(function(){
    var a = ( $(this).prop('checked') ) ? false: true;
    $(this).parents('.main_form').find('.button-wrp').find('button').prop('disabled', a);
});
...
$('.head-close').on('click', function(e) {
    e.preventDefault();
...
var count = 0;
  $('#counting input[type=checkbox]').change(function(){
    var sum = 0;  
    var arr = $('input:checked');
    arr.each(function(){
      var pr = $(this).siblings('span').html();
      if(pr == 'Бесплатно'){
        pr = 0;
      }
      sum += parseInt(pr);
...
//   $('[name="tel"]').mask('+7 (999) 999-99-99');
        ...
        function init () {
            ...
            var myPlacemark = new ymaps.Placemark([55.677275, 37.537380],{
    ...
    $(".modalka, button").click(function(e) {
